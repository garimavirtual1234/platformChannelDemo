...
class MainActivity: FlutterActivity() {
    ...
    //create Method channel with same name created in app
    private val  CHANNEL = "flutter.native/helper";

    //create MethodCallHandler in configureFlutterEngine method
    //create MethodChannel and call setMethodCallHandler()
